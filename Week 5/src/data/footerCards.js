export const footerCards = [
    {
        name: "Visa",
        svg: `<svg class='footer-cards-icon' viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg">
                        <path opacity=".07"
    ...
    {
        name: "Amex",
        svg: `<svg class='footer-cards-icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 38 24">
                        <path fill="#000"
                            d="M35 0H3C1.3 0 0 1.3 0 3v18c0 1.7 1.4 3 3 3h32c1.7 0 3-1.3 3-3V3c0-1.7-1.4-3-3-3Z"
                            opacity=".07" />
                        <path fill="#006FCF"
